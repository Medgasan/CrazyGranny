...
public class Jugador extends Personaje implements INeoColisionListener {

	private final static TipoPersonajes personaje = TipoPersonajes.CAPERUCITA;
	private final static String TAG = personaje.getTipo();
	private final static String SKIN = personaje.getSkin();
	public final static float POS_X_INI = 296;
	public final static float POS_Y_INI = 150;
	private final float VEL_INI = 105f;
	private final float COLISION_INI_W = 1.0f;
	...
	public Jugador(String file, float posX, float posY) {
		super(file, posX, posY);
	}

	public Jugador(String tag, String file, float posX, float posY) {
		super(tag, file, posX, posY);
	}

	public Jugador(String tag, String file, float posX, float posY, int frames,
			int anim) {
